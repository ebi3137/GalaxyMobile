...
const Col10 = () => {
  ...
  return (
    <div className="container max-w-[1336px] mx-auto lg:px-4 2xl:px-0">
      <div className="relative flex flex-col justify-center items-center border border-solid border-neutral-200 rounded-2xl py-4 px-2 gap-5">
      <button
        className={`absolute z-10 left-2 bg-white rounded-full p-2 border border-neutral-300 cursor-pointer transition duration-500 ${
      ...
      <button
        className={`absolute z-10 right-2 bg-white rounded-full p-2 border border-neutral-300 cursor-pointer transition  duration-500 ${
      ...
      >
        ...
        <div ref={scrollRef} className="grid grid-rows-3 grid-flow-col gap-4 overflow-x-auto scroll-hidden w-full">
